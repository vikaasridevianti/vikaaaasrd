                    ...
                    function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'Aku juga sayang banget sama ' + ' ' + nama + ' ' + 'hahahaha Love you',
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Terima kasih udah sayang sama aku' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Sekarang' + ' ' + nama + ' ' + 'kangen ga sama akuuuu?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    title: 'Sama aku juga kangen ih, makanya ketemu ayoook' + ' ' + nama +' '+ 'ku sayang xixixi',
                                                    icon: 'info',
                                                    showClass: {
                                                        popup: 'animate__animated animate__jackInTheBox'
                                                    },
                                ...
                                Swal.fire({
                                    title: 'Beneran yang? Aku tanya sekali lagi nih ayang. Sayang gak sama aku?',
                                    icon: 'question',
                                    text: 'Coba jawab yang bener ih',
                                    showCancelButton: true,
                                    confirmButtonText: 'Beneran, enggak',
                                    cancelButtonText: 'Ya, sayang banget',
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            ...
                                            Swal.queue([{
                                                title: 'Cobaaa seberapa sayang sih' + ' ' + nama + ' ' + 'ke aku?',
                                                confirmButtonText: 'Submit',
                                                showCancelButton: true,
                                                text: 'Coba isi pengen tau seberapa sayang kamu ke aku',
                                                showClass: {
                                                ...
                                                preConfirm: function (value) {
                                                    Swal.insertQueueStep({
                                                        title: 'Terima kasih yaaa uudah sayang ke aku hahaha' + ' ' + value + '%',
                                                        icon: "info"
                                                    })
                                                },
                                                allowOutsideClick: () => !Swal.isLoading()
